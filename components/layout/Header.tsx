        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center space-x-4 group">
            ...
            <div className="group-hover:translate-x-1 transition-transform duration-500">
              ...
              <div className="text-sm text-gray-600 font-medium tracking-wide max-w-[200px] leading-tight">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden lg:block">
              <Button className="btn-primary px-6 py-3 rounded-xl font-semibold shadow-elegant hover:shadow-luxury transition-all duration-300 transform hover:scale-105">
      ...
      >
        <div className="glass-card border-t border-gray-100/50 shadow-luxury">
          <div className="px-6 py-8 space-y-6">
            ...
            <div className="pt-4">
              <Button className="w-full btn-primary py-4 rounded-xl font-semibold shadow-elegant">
